...
دو برنامه ای که پروژه به آن احتیاج دارد: PostgreSQL , Python3
...
## نحوه اجرای پروژه:
ابتدا در پایگاه داده پستگرس ، سرور و دیتابیس با نام دلخواه ایجاد کنید و سپس در فایل جیسون در پوشه اصلی با نام Setup_db_connection،
...
حال آدرس  HTTP اجرا شده را در مروگری باز بفرمایید
